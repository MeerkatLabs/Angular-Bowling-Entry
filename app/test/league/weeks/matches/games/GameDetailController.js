 ...
 */
describe('league:weeks:matches:games:GameDetailController', function() {
    ...
    it('should create the game detail controller', inject(function($stateParams, $controller) {

        $stateParams.gameId = 1;

        var controller = $controller('GameDetailController', { league: league, week: week, match: match}, {});

        expect(controller.gameNumber).toBe(1);
        expect(controller.league).toBe(league);
        expect(controller.week).toBe(week);
        expect(controller.match).toBe(match);
